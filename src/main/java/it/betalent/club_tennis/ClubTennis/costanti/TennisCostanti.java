...
public class TennisCostanti {
	
	private TennisCostanti() {}
	...
	public static final String LEGGI_END_POINT = "/leggiUtente";
	public static final String CANCELLA_END_POINT = "/cancellaUtente";
